...
// OpenPGP algorithms first; SM2 is retained last for PIV's curve OID.
const uint8_t CK_ALGO_ATTR[CK_ALGO_ATTR_COUNT][CK_ALGO_ATTR_SIZE] = {
    ...
    [SM2] = {9, 0x00, 0x2A, 0x81, 0x1C, 0xCF, 0x55, 0x01, 0x82, 0x2D},
};
