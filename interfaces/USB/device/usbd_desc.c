...
static const uint8_t USBD_FS_CfgDesc[] = {
    ...
    0x03,                   /* bmAttributes: Interrupt endpoint */
    CTAPHID_EPOUT_SIZE,     /* wMaxPacketSize: 64 Bytes max  */
    0x00, 0x05,             /* bInterval: Polling Interval (5 ms) */
    ...
    CCID_EPIN_SIZE,         /* wMaxPacketSize: 64 Byte max */
    0x00, 0x00,             /* bInterval: Polling Interval */
    /* 120 */
    0x07,                   /* bLength: Endpoint Descriptor size */
    USB_DESC_TYPE_ENDPOINT, /* bDescriptorType: */
    CCID_EPOUT_ADDR,        /* bEndpointAddress: Endpoint Address (OUT) */
    0x02,                   /* bmAttributes: Interrupt endpoint */
    CCID_EPOUT_SIZE,        /* wMaxPacketSize: 64 Bytes max  */
    0x00, 0x00,             /* bInterval: Polling Interval */
    /* 127 */
};
